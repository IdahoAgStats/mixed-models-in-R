...
This is a simple model that can serve as a good entrance point to mixed models. We will assume 
...
|height | plant height at crop maturity |
...
|test weight | test weight (lbs per bushel of wheat) |
...
1. check the extent of missing data
1. inspect the independent variables and make sure the expected levels are present in the data
1. inspect the dependent variable to ensure its distribution is following expectations

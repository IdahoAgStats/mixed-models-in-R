...
Readers of this materials are welcome to test any of the code in this guide. All data used in this tutorial are from previously conducted studies and are available in the [GitHub repository](https://github.com/IdahoAgStats/mixed-models-in-R/tree/main/data){.external target="_blank"} for this resource and explained in the chapters they are used. You can also download all data sets as a zipped file (51 kb). 

...
For this these models, we will use ***nlme***. This packages have the easiest implementation of heterogeneous error structures.Another package, [***mmrm***](https://CRAN.R-project.org/package=mmrm){.external target="_blank"}, does provide functionality for repeated measures for limited experimental designs, but we will not be exploring that.  While [it is possible](https://bbolker.github.io/mixedmodels-misc/notes/varmats.html){.external target="_blank"} to do this with **lme4**, but it requires extensive comfort programming in **lme4**.
...
| Structure name | nlme function  | Assumption |
|------------------------|------------------------|------------------------|

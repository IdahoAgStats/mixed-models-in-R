...
write.csv(repeated_meas, here::here("data", "repeated_meas.csv"))
```
...
hist(dat$y, main = "", xlab = "leaf area index", cex.lab = 1.8, cex.axis = 1.5, col = "turquoise")
```
...
save(fit1, file = here::here("data/phos_fit1.RData"))
```

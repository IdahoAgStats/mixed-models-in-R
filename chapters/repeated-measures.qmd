...
str(Yield$Sample_time)
str(Yield$plot)
Yield$plot1 <- as.character(Yield$plot)

corr_str1 = corAR1(form = ~ Sample_time|Rep/Variety/plot1, value = 0.2, fixed = FALSE)

m_2023A1 <- lme(pH ~ Sample_time1*Variety*Fertilizer,
                random = ~ 1|Rep/Variety/plot1,
                corr = corr_str1,

...
Note that if your response variable did not import as numeric autommaticaly, this is an indicator that there may be problems with the observations that need attention. Perhaps a decimal point with replaced with a comma instead, a "O" was typed instead of "0", or maybe there were unexpected methods of representing missing values. It is a good to check and make sure there are no data entry errors before proceeding with analysis. 

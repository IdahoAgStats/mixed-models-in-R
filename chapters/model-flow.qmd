...
#| echo: false
#| warning: false
#| fig-caption: "Field Plot Layout of Example Scenario"
...
# edit this one
table1 <- data.frame(
  col1 = c("Location", "Block", "", "", "", "TD Unit(location)", "Unit(block:Location)", "Total"),
  col2 = c("3-1=2", "4-1=3", "", "", "", "(3-1)3=6", "(3-1)*3*3=18", "(3*3*3*4) - 1 = 107"),
  col3 = c("", "", "Termination Date", "Cover Cropping", "TD x CC", "", "", ""),
  col4 = c("", "", "3-1=2", "3-1=2", "(3-1)(3-1)=4", "", "", ""),
  col5 = c("Location", "Block", "Termination Date", "Cover Cropping", "TD x CC", 
           "TD Unit(location)|TD", "Unit(block:Location)|CC", "Total"),
  col6 = c(2, 3, 2, 2, 4, 6, 18, 107)
)

# don't edit this one, it's the working example
table0 <- data.frame(
...
kable(table1, col.names = NULL,  align = rep(c("l", "l"), 3), format = "html") |> 
 ...
 # footnote("*Unit-within-block effects after accounting for treatment effects.") # this was added manually instead to the bottom of the table

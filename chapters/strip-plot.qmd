...
For this example, we will use Rice strip-plot experiment data from the`agridat` package. This data contains a strip-plot experiment with three reps, variety as the horizontal strip and nitrogen fertilizer as the vertical strip.

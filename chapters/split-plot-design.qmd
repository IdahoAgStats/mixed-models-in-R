...
write.csv(dframe, here::here("data/split_plot_crd.csv"), row.names=FALSE)
...
write.csv(dframe2, here::here("data/split_plot_rcbd.csv"), row.names=FALSE)
```

```{r, echo=FALSE, message=FALSE, fig.height=3.5}
library(ggplot2)
spd <- read.csv(here::here("data/split_plot_crd.csv"))
...
spd2 <- read.csv(here::here("data/split_plot_RCBD.csv")) 
...
hist(height$height, main = NA, xlab = "height", cex.lab = cex_lab, cex.axis = cex_axis, col = base_plot_color)
```

```{r, eval=FALSE}
hist(height$height, main = NA, xlab = "height")
```
...
```{r, eval=FALSE}
hist(oats$Y, main = NA, xlab = "yield", col = base_plot_color)
```

...
#| column: margin
hist(potato$LxW, ylab=NULL, xlab = NULL, main = "Potato Clone LxW Ratio", col = base_plot_color, breaks = 20)
```
...
#| column: margin
hist(clone_re$BLUP, ylab=NULL, xlab = NULL, main = "Clone Random Effects", col = base_plot_color)
```
...
#| column: margin
hist(log(wa_salary$salary), ylab=NULL, xlab = NULL, main = "Washington Higher Ed Salaries", col = base_plot_color)
```

...
#| echo: false
#| 
hist(1/potato$LxW, ylab=NULL, xlab = NULL, cex.lab = cex_lab, cex.axis = cex_axis, main = NA, col = base_plot_color, breaks = 20)
```
...
#| column: margin
hist(log(wa_salary$salary), ylab=NULL, xlab = "log of salaries", cex.lab = cex_lab, cex.axis = cex_axis, main = NA, col = base_plot_color)
```
...
#| column: margin
boxplot(log(salary) ~ year, data = wa_salary, ylab=NULL, xlab = NULL, main.cex = 1.4, main = ' "0" = 2019', col = base_plot_color)
```
...
```{r, echo=FALSE}
#| fig-cap: "Histogram of Oilseed Yield"
#| column: margin
#| echo: false

hist(var_ex1$yield, main=NA, col = base_plot_color, ylab=NULL, xlab = NULL, cex.lab = cex_lab, cex.axis = cex_axis,)
```
...
hist(var_ex2$yield, main=NULL, col = base_plot_color, ylab=NULL, xlab = NULL, cex.lab = cex_lab, cex.axis = cex_axis,)
```
...
It is the choice of the researcher whether to use this model or a simpler model assuming equal variance. 

...
This is a common scenario: an experiment is conducted and their are multiple grouping levels, none of which are nested within each other, but the observations have differential group memberships. 
...
#| column: margin
hist(potato$LxW, ylab=NULL, xlab = NULL, main = "Potato LxW Ratio", col = "turquoise")
```

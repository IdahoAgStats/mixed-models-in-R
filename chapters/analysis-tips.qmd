...
[^analysis-tips-1]: For an excellent set of basic instructions on data preparation, please see: Broman, K. W., & Woo, K. H. (2018). [Data Organization in Spreadsheets](https://doi.org/10.1080/00031305.2017.1375989){.external target="_blank"}. The American Statistician, 72(1), 2–10. 
...
[^analysis-tips-2]: Wasserstein, R. L., & Lazar, N. A. (2016). [The ASA Statement on p-Values: Context, Process, and Purpose](https://doi.org/10.1080/00031305.2016.1154108){.external target="_blank"}. *The American Statistician,* 70(2), 129–133.
...
To learn more about common pitfalls in interpreting p-values, check out our [blog post](https://agstats.io/posts/p-values/){.external target="_blank"} on the subject and/or this paper[^analysis-tips-3] on the subject. 

[^analysis-tips-3]: Greenland S, Senn SJ, Rothman KJ, Carlin JB, Poole C, Goodman SN, Altman DG. (2016) [Statistical tests, P values, confidence intervals, and power: a guide to misinterpretations](https://doi.org/10.1007/s10654-016-0149-3){.external target="_blank"}. *Eur J Epidemiol*. 31(4):337-50. 

...
Often, I see researchers use [compact letter display](https://en.wikipedia.org/wiki/Compact_letter_display){.external target="_blank"} (e.g. "A", "B", "C", ....) for indicating differences among treatments. This makes for concise presentation of results in tables and figures, but it can kill statistical power and misses nuance in the results.

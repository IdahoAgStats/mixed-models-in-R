...
Statistical analysis is hard. Despite the common view that science produces unambiguous truths, science and statistics involve making decisions and judgement calls that affect the outcomes and conclusions of a study. These decisions are informed by our scientific thinking and (hopefully) justified in our manuscripts so they can be interrogated by other experts. The website 538 published a [well-researched article](https://fivethirtyeight.com/features/science-isnt-broken/#part1) describing some of these difficulties, the temptation to "[p-hack](https://en.wikipedia.org/wiki/Data_dredging)" and the consequences for scientific research. 

This does not mean we should resign ourselves to get it wrong, but try our best to approach analysis remembering that the goal is to obtain truth, not obtain a low p-value. 

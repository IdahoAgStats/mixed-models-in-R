...
This looks great! Here we can see that there are an equal number of treatments, rows, and columns (5). Treatments were randomized so that one treatment does not appear more than once in each row and column.
...
We see that wheat yield was higher with 'C' fungicide treatment compared to other fungicides applied in this study, indicating that 'C' fungicide was more efficient in controlling stem rust in wheat.

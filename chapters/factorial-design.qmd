 ...
 **agridat** package (data set "yates.missing"). This data comprises a infection intensity (y) response of potato tubers to different levels of  nitrogen (n), phosphorus (p), potassium (k) treatments.

The objective of this example is to evaluate the individual and interactive effect of  location and treatment on, "p", and "k" treatments on bean yield.

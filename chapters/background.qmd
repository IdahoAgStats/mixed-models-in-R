...
The main advantage of the LMMs is their flexibility to handle clustered data as well as data with the repeated measures. This model can also handle nested as well as crossed random effects. However, at the same time, these models can be easily mis-specifed when you are a LMM user.

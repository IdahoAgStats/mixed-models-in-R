...
Model statement 
{[[[[ FIX THIS - it's still written for alfalfa ]]]]}
...
There are several other specialized covariance structures implmented by glmmTMB. 
In general, repeated measures syntax follow this convention: `(time + 0 | grouping)`.
...
Fitting glmm is hard.
Basic guidance on model fitting: https://glmmtmb.github.io/glmmTMB/articles/troubleshooting.html
```{r}
diagnose(m2)
diagnose(m3)
```
...
```{r}
simulated_resids <- simulateResiduals(m1_c)
